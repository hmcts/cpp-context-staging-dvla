...
public class AppealScenariosIT extends AbstractIntegrationTest {
    ...
    @Test
    public void cimd_3238_ac2() throws IOException {
        List<DriverNotified> driverNotifiedList = sendAndVerifyEvent("appealAmendReshare/cimd_3238_ac2/command1.json", 1);
    ...
    @Test
    public void cimd_3240_ac1() throws IOException {
        List<DriverNotified> driverNotifiedList = sendAndVerifyEvent("appealAmendReshare/cimd_3240_ac1/command1.json", 1);
        ...
        driverNotifiedList = sendAndVerifyEvent("appealAmendReshare/cimd_3240_ac1/command2.json", 0);
    }

    @Test
    public void cimd_3240_ac2() throws IOException {
        List<DriverNotified> driverNotifiedList = sendAndVerifyEvent("appealAmendReshare/cimd_3240_ac2/command1.json", 1);
        ...
        driverNotifiedList = sendAndVerifyEvent("appealAmendReshare/cimd_3240_ac2/command2.json", 0);
    }
    ...
    public void cimd_3241_ac1_ac2() throws IOException {
        ...
        DriverNotifiedEventAssertion.with(driverNotifiedList.get(0))
                ...
                .hasSentenceDate(1, "2026-05-16")
                .hasSentenceDate(2, "2026-05-16")
                .hasSentenceDate(3, "2026-05-16")
                .hasSentenceDate(4, "2026-05-16")
                .hasSentencingCourtCode(1, "1577")
                .hasSentencingCourtCode(2, "1577")
                .hasSentencingCourtCode(3, "1577")
        ...
        DriverNotifiedEventAssertion.with(driverNotifiedList.get(0))
                ...
                .hasSentenceDate(1, "2026-09-17")
                .hasSentenceDate(2, "2026-05-16")
                .hasSentenceDate(3, "2026-12-18")
                .hasSentenceDate(4, "2026-05-16")
                .hasSentencingCourtCode(1, "2577")
                .hasSentencingCourtCode(2, "1577")
                .hasSentencingCourtCode(3, "3577")
                .hasSentencingCourtCode(4, "1577")
                .hasResults(1, 1)
                .hasResults(2, 2)
                .hasResults(3, 2)
    ...
    @Test
    void cimd_3810() throws IOException {
