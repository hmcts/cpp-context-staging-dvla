...
public class DriverService {
    ...
    public DriverResponse findByDriverNumber(final DriverQueryParameters queryParameters) {
        ...
        try {
            ...
            final String payload = JsonObjects.createObjectBuilder().add("drivingLicenceNumber", driverNumberFunc.apply(queryParameters.getDriverNumber())).build().toString();
    ...
    public DriverImageResponse findDriverImage(final DriverImageQueryParameters queryParameters) {
        ...
        try {
            ...
            final JsonObjectBuilder builder = JsonObjects.createObjectBuilder().add("drivingLicenceNumber", driverNumberFunc.apply(queryParameters.getDriverNumber()));
    ...
    private Error getErrorMessage(final String responseAsString) {
        ...
        try (final JsonReader jsonReader = JsonObjects.createReader(new StringReader(responseAsString))) {
    ...
    private String prepareJsonPayload(final Map<String, Object> params) {
        ...
        final JsonObjectBuilder criteria = JsonObjects.createObjectBuilder();
        final JsonObjectBuilder optionsBuilder = JsonObjects.createObjectBuilder();
