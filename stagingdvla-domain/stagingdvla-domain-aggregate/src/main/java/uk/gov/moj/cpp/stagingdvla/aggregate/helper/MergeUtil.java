...
public class MergeUtil {
    ...
    public static DefendantCaseOffences mergeOffence(final DefendantCaseOffences offence,
                                                     ...
                                                     final String orderDate, final String orderingCourtCode, final boolean hasAppealResultOrGranted, final boolean isReopenedApp) {
        final DefendantCaseOffences mergedOffence = DefendantCaseOffences.defendantCaseOffences()
                ...
                .withResults(hasAppealResultOrGranted || isReopenedApp
