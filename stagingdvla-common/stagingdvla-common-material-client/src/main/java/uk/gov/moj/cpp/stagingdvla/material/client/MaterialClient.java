...
/**
 * Staging-DVLA-owned copy of material's HTTP adapter (decouples staging-dvla from the material-client
 * JAR - PEG-3448). Trimmed to the single method staging-dvla uses; runtime behaviour is unchanged -
 * staging-dvla still calls material over HTTP exactly as before.
 */
@ApplicationScoped
